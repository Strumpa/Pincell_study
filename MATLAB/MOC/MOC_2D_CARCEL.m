...
nmu = 2 ; %polar angle quadrature order 2, 3, 4 to test to compare with DRAGON5
...
pii = mcgpii(tracks, sig_tot, nmu, nmu, 1) ;

Phi = free(phi,nu_sig_f,"mcgsis",errtol,maxit,tracks,sig_tot,sig_scattering,pii,nmu,beta) ;
